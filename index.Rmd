...
* For a demonstration of my knowledge in R I have provided some interactive plots and graphs on a [flexdashboard.](flexdashboard.html) These plots were created using an NYC Restaraunt Inspection Dataset.

* For more examples of my work, feel free to click on the GitHub icon in the navigation bar to view my GitHub account.

## Contact Me

* I can be contacted via email using the mail icon in the navigation bar or the by messaging me on LinkedIn, also accessible from the navigation bar.
